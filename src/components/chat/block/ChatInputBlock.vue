  ...
  <div ref="resizeableDivRefs" class="pb-4" :style="{ height: divHeight + 'px' }">
    ...
    <div class="w-full h-full flex flex-row relative">
      <textarea ref="chatInputTextAreaRefs"
        ...
        v-model="chatInputContent" placeholder="试试输入任何你想了解的问题" @keydown.enter.prevent.exact="enterKeyDown"
        @keydown.shift.enter.prevent.exact="shiftEnterKeyDown" @keydown.ctrl.enter.prevent.exact="ctrlEnterKeyDown" />
      <div @click.stop="submitContent"
